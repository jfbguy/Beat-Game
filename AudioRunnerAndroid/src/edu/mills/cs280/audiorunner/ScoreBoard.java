...
public class ScoreBoard {
	...
	/**
	 * Nested ScoreFloater Class for adding scores that float eventually to the
	 * score board
	 * 
	 * @param Integer
	 *            , X position to start
	 ...
	 */
	class ScoreFloater {
		private final float FLOATERSIZE = .8f; // ratio of size floaters will
												// draw as
		 ...
		 * 
		 * @param x
		 *            Assigns position of X to x
		 * @param y
		 *            Assigns position of Y to y
		 * @param points
