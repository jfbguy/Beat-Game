...
/**
 * Handles the start page (main menu) of the application. Plays a song while
 * user navigates the application. Song will stop when user terminates or exits
 * application.
 * 
 * @author jvizcain
 * 
...
public class MainMenu extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		settings.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				Intent thisIntent = new Intent(view.getContext(),
						VolumeSeekBar.class);
